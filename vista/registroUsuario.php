    ...
    <div class="modal fade bd-registrousu-modal-lg" id="registrousu" tabindex="-1" role="dialog" aria-labelledby="labelModal" aria-hidden="true">
      <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
           ...
           <form method="post" action="" id="form_registro">
            <div class="row">
              <div class="col-md-6">
                ...
                <input class="" type="radio" name="V"  id="V" value="V">
                <label for="V">Venezolano</label>
                <input class="" id="E" name="E" type="radio" value="E" />
          ...
          <div>
            <button type="submit" class="btn btn-danger btn-sm pull-right btn-round" id="registroUsuario">Guardar Datos</button>
          </div>    
