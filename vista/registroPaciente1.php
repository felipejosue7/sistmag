            ...
            <form method="post" action="" id="form_registro">
              <div class="row">                
                <div class="col-md-6">
                  ...
                  <input class="nacionalidad_paciente" type="radio" name="nacionalidad_paciente"  id="V" value="V">
                  <label for="V">Venezolano</label>
                  <input class="nacionalidad_paciente" type="radio"  name="nacionalidad_paciente" id="E" value="E" />
              ...
              <div class="row">
                <div class="col-md-6">
                  <div class="form-group label-floating has-success">
                    ...
                    <input type="text" name="nombre" id="nombre" class="form-control" data-validation="custom" data-validation-regexp="^([a-z][A-Z]+)$" data-validation-error-msg="Ingrese sólo letras" >
                  </div>
                </div>
                <div class="col-md-6">
                  <div class="form-group label-floating has-success">
              ...
              <div class="row">
                <div class="col-md-5">
                  <div class="form-group label-floating has-success">
                    ...
                    <input type="email" name="email" id="email" data-validation="email" data-validation-error-msg="Ingresa una dirección de correo válida">
