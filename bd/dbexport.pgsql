...
CREATE TABLE caso (
    ...
    origen_parroquia integer NOT NULL,
    clasificacion_caso character varying(100) NOT NULL
);
...
--
-- Name: COLUMN estado.id; Type: COMMENT; Schema: public; Owner: postgres
--

COMMENT ON COLUMN estado.id IS 'Identificador de la tabla';
...
--
-- Name: COLUMN municipio.id; Type: COMMENT; Schema: public; Owner: postgres
--

COMMENT ON COLUMN municipio.id IS 'Identificador de la tabla';
...
CREATE TABLE paciente (
    ...
    estadocivil_paciente character varying(12),
...
CREATE TABLE paciente_descripcion (
...
ALTER TABLE paciente_descripcion OWNER TO postgres;
...
COMMENT ON COLUMN parroquia.id IS 'Identificador de la tabla';
...
CREATE TABLE pruebas (
    ...
    lugar_toma_lamina character varying(20),
    estado_toma_lamina character varying(15),
    municipio_toma_lamina character varying(20),
    parroquia_toma_lamina character varying(20)
);
...
--
-- Name: pruebas_parroquia_toma_lamina_seq; Type: SEQUENCE; Schema: public; Owner: postgres
--

CREATE SEQUENCE pruebas_parroquia_toma_lamina_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
ALTER TABLE pruebas_parroquia_toma_lamina_seq OWNER TO postgres;

--
-- Name: pruebas_parroquia_toma_lamina_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: postgres
--

ALTER SEQUENCE pruebas_parroquia_toma_lamina_seq OWNED BY pruebas.parroquia_toma_lamina;
...
COPY caso (id_caso, numero_caso, origen, muerte, recaida, origen_parroquia, clasificacion_caso) FROM stdin;
1	123	ttt	ff	ff	1	frfff
2	124	gggg	vv	ff	2	httyt
\.
...
SELECT pg_catalog.setval('caso_id_seq', 2, true);
...
COPY descripcion (id_descripcion, peso, embarazada, madre_lactante, lactante) FROM stdin;
\.
...
COPY paciente (id_paciente, numero_paciente, nombre_paciente, apellido_paciente, cedula_paciente, nacionalidad_paciente, fecha_nacimiento, direccion_paciente, sexo_paciente, telefono_paciente, etnia_paciente, id_municipio, id_parroquia, id_estado, id_usuario_sistema, email_paciente, estadocivil_paciente, ocupacion, peso_paciente) FROM stdin;
1	123	erly	heredia	fgf55	ffg	1990-03-19	fgffh	hghjg	453	ghghj	1	3	4	4	jhgjh	ghg	\N	\N
6		Felipe	Cordero Gonzalez	7180182		2018-10-05					\N	\N	\N	1			\N	\N
9		Aliangy	Rodriguez	21296268		2018-10-05					2	2	2	1			\N	\N
19		werwewr	qweeqwe	12311123		2018-10-05					2	4	2	1			\N	\N
20		werwewr	qweeqwe	12311123		2018-10-05	esta es la dureccuin				2	4	2	1			\N	\N
21		werwewr	qweeqwe	12311123		2018-10-05	esta es la dureccuin				2	4	2	1			\N	\N
24		123131233	12131	1231231		2018-10-05	weqeqwddddd				2	2	2	1			\N	\N
26		jghjgfvj	bcfghcfg	222222	2	2018-10-05	gfddfgf	4	4	hfffgh	3	4	2	1			\N	\N
33		 Felipe Josue	 Cordero Gonzalez	 7180182	\N	2018-10-05	 ddsada	\N	\N		\N	\N	\N	1	msmsmsm@gmail.com	\N	\N	\N
38		Douglas 	Suarez	23489754	2	2018-10-05	piekfuhasjhf	3	\N	fFHFHSSHFF	\N	\N	11	1	fffkjfhfh@gmail.com	5	mamador	80
39		heredia	erly	23489754	3	2018-10-05	el guevo	3	\N	mamo	\N	\N	5	1	erlyherdia@hotmail.com	2	chimo	75
40		jose	cadenas	23489754	2	2018-10-05	cadena	2	04164587412	nac	\N	\N	4	1	hackermint@gmail.com	3	hacker	60
41		fdsffs	dssaadasd	252525	2	2018-10-05	vcvvcxcvcc	2	1414141	41	4	28	2	1	dsds@gmai.com	3	xxcxcc	100
\.
...
COPY paciente_descripcion (id_paciente_descripcion, id_paciente, id_descripcion) FROM stdin;
\.
...
SELECT pg_catalog.setval('paciente_id_seq', 41, true);
...
COPY paciente_pruebas (id_paciente_pruebas, id_paciente, id_pruebas) FROM stdin;
\.
...
COPY pruebas (id_pruebas, tipo_prueba, codigo_notificacion, numero_lamina_pdrm, tipo_busqueda, especie_plasmodium, fecha_inicio_fiebre, fecha_toma_lamina, lugar_toma_lamina, estado_toma_lamina, municipio_toma_lamina, parroquia_toma_lamina) FROM stdin;
\.


--
-- Name: pruebas_parroquia_toma_lamina_seq; Type: SEQUENCE SET; Schema: public; Owner: postgres
--

SELECT pg_catalog.setval('pruebas_parroquia_toma_lamina_seq', 1, false);
...
COPY usuario_sistema (id_usuario_sistema, usuario_sistema, clave, nombre, apellido, cedula, id_rol, telefono_usuario) FROM stdin;
\.
...
ALTER TABLE ONLY paciente_descripcion
...
ALTER TABLE ONLY paciente_descripcion
    ADD CONSTRAINT paciente_descripcion_id_descripcion_fkey FOREIGN KEY (id_descripcion) REFERENCES descripcion(id_descripcion) ON UPDATE CASCADE ON DELETE CASCADE;
...
ALTER TABLE ONLY paciente_descripcion
    ADD CONSTRAINT paciente_descripcion_id_paciente_fkey FOREIGN KEY (id_paciente) REFERENCES paciente(id_paciente) ON UPDATE CASCADE ON DELETE CASCADE;
...
ALTER TABLE ONLY parroquia
    ADD CONSTRAINT parroquia_municipio_id_fkey FOREIGN KEY (municipio_id) REFERENCES municipio(id) ON UPDATE CASCADE ON DELETE CASCADE;
