              ...
              <form method="get" action="" id="form_mod">
                    ...
                    <div class="form-row">
                     ...
                     <div class="form-group col-lg-4 col-md-4 col-sm-4">
                      <select class="form-control" type="" name="nacionalidad_paciente" id="nacionamod"  data-style="btn btn-success btn-round">
                        ...
                        if ($nac == 2) { ?>
                         <option value="2" selected="selected">Venezolano</option>
                       <?php  } else { ?>
                         <option value="2" >Venezolano</option>
                       <?php }
                       if ($nac == 3) {?>
                         <option value="3" selected="selected">Extranjero</option>
                       <?php } else{ ?>
                ...
                <div class="form-row">
                  ...
                  <div class="input-group date" data-provide="">
                   ...
                   value="<?php echo $pac->fecha_nacimiento; ?>">
...
<script type="text/javascript">
  ...
  $(document).ready(function() {
    ...
    $("#edocivilmod").on('change', function () {
      /* Act on the event */

      $("#edocivilmod option:selected").each(function () {
