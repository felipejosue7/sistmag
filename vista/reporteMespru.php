...
<div class="row">
  <div class="col-md-12">
    ...
    <div class="card-body">
      <div class="table-responsive datatables"><title>Reporte Mensual de Pruebas Realizadas <?php echo $fecha ?></title>
...
<script type="text/javascript">
 ...
 $(document).ready(function() {
  ...
  buttons: [
  {
    ...
    messageTop: 'Reporte Mensual de Pruebas Realizadas',     
    download: 'open',
