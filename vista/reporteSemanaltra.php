  ...
  <div class="col-md-8">
    <div class="card">
      <div class="card-header card-header-success">
        <h4 class="card-title">
          Reportes de tratamiento por semanas
        </h4>
    ...
    <div class="card-body">
      <div class="table-responsive datatables">
        <table class="table display" data-toggle="table" id="reporte">
          ...
          <tbody>
            <?php
            foreach ($datosreportesemanatra as $paciente =>
              $valor) :   ?>
 ...
 $(document).ready(function() {
  ...
  $('#reporte').DataTable( {
    ...
    buttons: [
    {
      ...
      messageTop: 'Reporte Semanal de Tratamientos Realizados',    
      download: 'open',
