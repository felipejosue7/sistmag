  ...
  <div class="wrapper ">
    ...
    <div class="content">
      <div class="container-fluid">     
       <div class="row">
        <div class="col-md-12">
          <a class="navbar-brand-danger">Bienvenid@ <?php echo $_SESSION["nombre"]." ". $_SESSION["apellido"] ?>  al Sistema Web del Departamento de Malariología</a>  
        </div>
        <div class="col-md-12">
          <a class="navbar-brand-danger">Usted inició sesión como <?php echo $_SESSION["descripcion"] ?></a>  
        </div>
      </div>
    </div>
