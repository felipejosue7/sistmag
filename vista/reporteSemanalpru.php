  ...
  <div class="col-md-8">
    <div class="card">
      <div class="card-header card-header-success">
        <h4 class="card-title">
          Reportes de Pruebas por Semanas
        </h4>
...
<div class="row">
  <div class="col-md-12">
    ...
    <div class="card-body">
      <div class="table-responsive datatables"><title>Reporte Semanal de las Pruebas Realizadas  <?php echo $fecha ?></title>
        <table class="table display" data-toggle="table" id="reporte">
          <thead class=" text-info">
            <tr>
              ...
              <td>
                Fecha de Toma de Lámina
              </td>
              <td>
                Lugar de Toma de Lámina
              </td>      
            </tr>
          </thead>
          ...
          <tbody>
            <?php
            foreach ($datosreportesemanapru as $paciente =>
              $valor) :   ?>
...
<script type="text/javascript">
 ...
 $(document).ready(function() {
  ...
  buttons: [
  {
    ...
    messageTop: 'Reporte Semanal de Pruebas Realizadas',      
    download: 'open',
